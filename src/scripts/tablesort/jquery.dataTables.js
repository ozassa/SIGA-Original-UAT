	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "Exibir _MENU_ Por p&aacute;gina",
				"sZeroRecords": "Nenhum Registro encontrado",
				"sEmptyTable": "Nenhum dado retornado na tabela",
				"sInfo": "Exibindo _START_ de _END_ de _TOTAL_ Encontrados",
				"sInfoEmpty": "Exibindo 0 de 0 de 0 Encontrados",
				"sInfoFiltered": "(filtrado de _MAX_ encontrados)",
				"sInfoPostFix": "",
				"sSearch": "Buscar",
				"sUrl": "",
				"oPaginate": {
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select style="width:64px;" size="1" '+sName+'>';
			var i, iLen;
