...
odbc_execute($rsSql, ['550', $idUser, $id_Cessao, NULL]);
...
<div class="conteudopagina">
  ...
  <div class="barrabotoes">
    <button class="botaovgm" type="button"
      onClick="window.location = '<?php echo $host; ?>src/role/cessao/Cessao.php?comm=cancelaCessaoDireitoSeguradora';">Voltar</button>
  ...
  <div class='modal-int'>
    ...
    <li class="barrabotoes" style="list-style:none;*margin-left:-15px;width:700px;">
      ...
      <button type="button" class="botaoagm"
        onClick="window.location = '<?php echo htmlspecialchars($host, ENT_QUOTES, 'UTF-8'); ?>src/role/cessao/Cessao.php?comm=cancelarCessaoDireitoSeguradora&id_Cessao=<?php echo htmlspecialchars($id_Cessao, ENT_QUOTES, 'UTF-8'); ?>';">Sim</button>
