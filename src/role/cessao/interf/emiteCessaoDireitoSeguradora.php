<?php
  ...
  $sql = "EXEC SPR_BB_Consulta_Cessao_Direito '200', '".$idUser."', NULL, NULL";
    ...
    <?php 
        ...
        for ($a=0; $a < count($dados); $a++) { ?>
          <tr>
            ...
            <td>
              <a href="<?php echo $host;?>src/role/cessao/Cessao.php?comm=viewEmiteCessaoDireitoSeguradora&id_Cessao=<?php echo $dados[$a]['id_Cessao']; ?>" class="btn">Visualizar</a>
            </td>
          </tr>
      <?php } ?>
    <?php } ?>    
