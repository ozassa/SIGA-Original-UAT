...
<?php function arruma_cnpj($c){
  ...
  $cur=odbc_exec($db,
	...
	a.telefone, a.email, a.contato, a.agTel FROM Agencia a
...
<?php }?>
   ...
   <!-- Aletado por Michel Saddock 10/08/2006 -->
    <TR>
    <TD>Telefone: </TD>
    <TD class="texto"><input class="texto" type="text" name="agTel" size="50" value="<?php echo odbc_result($cur,13);?>">&nbsp;</TD>
   </TR>
   <TR>
    <TD>Endereço: </TD>
...
<!--input class="texto" type="text" name="region" size="30" value="<?php echo odbc_result($cur,6);?>">&nbsp;</TD-->
   ...
   <TR>
    ...
    <TD class="texto"><input class="texto" type="text" name="contato" size="49" value="<?php echo odbc_result($cur, 12);?>">&nbsp;</TD>
   </TR>
   <TR>
    <TD>Telefone do Contato: </TD>
    <TD class="texto"><input class="texto" type="text" name="telefone" size="20" value="<?php echo odbc_result($cur, 10);?>">&nbsp;</TD>
   </TR>
   <TR>
    <TD>E-mail do Contato: </TD>
    <TD class="texto"><input class="texto" type="text" name="email" size="49" value="<?php echo odbc_result($cur, 11);?>">&nbsp;</TD>
   </TR>
