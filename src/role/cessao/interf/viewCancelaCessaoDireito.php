...
odbc_execute($rsSql, ['350', $idUser, $id_Cessao, $idInform]);
...
<div class="conteudopagina">
  ...
  <div class="barrabotoes">
    <button class="botaovgm" type="button"
      onClick="window.location = '<?php echo htmlspecialchars($host, ENT_QUOTES, 'UTF-8'); ?>src/role/cessao/Cessao.php?comm=cancelaCessaoDireito&idInform=<?php echo urlencode($idInform); ?>';">
      Voltar
    </button>
    <button class="botaoagg <?php echo $perm_cert ? 'js-cancelar_cessao' : 'js-certificado'; ?>" type="button">
      Cancelar Cess&atilde;o
    </button>
  </div>
...
<div class="modal-certificado" style="display:none">
  ...
  <div class='modal-int'>
    ...
    <li class="campo2colunas" style="width: 690px;">
      <label>&nbsp;</label>
      <p>Para cancelar a Cess&atilde;o de Direito, &eacute; obrigat&oacute;rio a Certifica&ccedil;&atilde;o
        Digital.</p>
    </li>
  ...
  <div class='modal-int'>
    ...
    <li class="barrabotoes" style="list-style:none;*margin-left:-15px;width:700px;">
      ...
      <button type="button" class="botaoagm"
        onClick="window.location = '<?php echo htmlspecialchars($host, ENT_QUOTES, 'UTF-8'); ?>src/role/cessao/Cessao.php?comm=cancelarCessaoDireito&idInform=<?php echo urlencode($idInform); ?>&id_Cessao=<?php echo urlencode($id_Cessao); ?>&key_id=<?php echo urlencode($key); ?>'; 
    setTimeout(function() { window.open('<?php echo htmlspecialchars($host, ENT_QUOTES, 'UTF-8'); ?>src/role/cessao/distrato_pdf.php?id_Cessao=<?php echo urlencode($id_Cessao); ?>&key_id=<?php echo urlencode($key); ?>', '_blank'); }, 1000);">
        Sim
      </button>
    </li>
