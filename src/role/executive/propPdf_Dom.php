...
//error_reporting(E_ALL);
	...
	$sqlquery  = "Select E.*,P.Nome as Produto, SP.Descricao as SubProduto, SP.c_SUSEP,Inf.i_Gerente, Inf.contrat, Inf.nProp, Inf.Prazo_Nao_Intencao_Renov 
		From Inform Inf
		...
		<body>';
					...
					<htmlpagefooter name="myfooter">
						<table width="100%" border="0">
							<tr>
								<td width="40%" style="text-align:left; font-size: 8pt;">'.$nomeEmp.'</td>
								<td width="10%" style="text-align:center; font-size: 8pt;">		
									Página {PAGENO} de {nb}								
								</td>
	
								<td width="40%" style="text-align:right; font-size: 8pt;">Processo SUSEP n° 15414.005252/2005-53</td>
							</tr>
						</table>
