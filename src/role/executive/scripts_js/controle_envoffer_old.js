...
///////////////////////////////////////////////////////////////////////////////////////
  ...
  function exibir_modulo(subproduto,id,url){
	...
	function exibir_bonus(valor){
         if(document.getElementById('idModuloF9.02').checked == true) {
    ...
    function tipoBanco(xtipo){
       if (document.getElementById('tipobanco').value == '0') { // BB
	        if(document.getElementById('i_Produto').value != 1){
	...
	function exibir_derrogacoes(obj,valor){
		  if(obj.checked == true) {
			  document.getElementById('mostraderrogacao'+valor).style.display = 'block';
		  }else {
			  document.getElementById('mostraderrogacao'+valor).style.display='none';
		  }
	...
	function verDerrogacao(obj, num){
	      if(obj.checked == true) {
			  document.getElementById('verDerrogacao'+num).style.display = 'block';
		  }else {
			  document.getElementById('verDerrogacao'+num).style.display='none';
		  }
	...
	function verDerrogacaoEspecial(obj, num, modulo){
		if(modulo == 'F13.02'){
	      if(obj.checked == true) {
			  document.getElementById('verDerrogacao'+num).style.display = 'block';
			  document.getElementById('verDerrogacao'+ (num +1)).style.display='none';
			  document.getElementById('verDerrogacao'+ (num +2)).style.display='none';
		  }else { 
			  document.getElementById('verDerrogacao'+num).style.display='none';
			  document.getElementById('verDerrogacao'+ (num +1)).style.display='none';
			  document.getElementById('verDerrogacao'+ (num +2)).style.display='none';
