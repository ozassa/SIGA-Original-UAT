<?php 
	...
	$assinatura2 = $root .'images/Assinatura_Rigobello.jpg';
  		...
  		<html>
				...
				<body>				
					...
					<div class="rounded">
						<table style="width:100%; border: 0;" >
							<tr>
								<td colspan="3" style="text-align:justify;">Emite esta Apólice de Seguro de Crédito '.($i_Produto == 1 ? "Doméstico" : "à Exportação").', que é composta pelo presente documento, 
											'.($SubProduto == 1 ? "pela Especificação da Apólice" : "pelas Condições Particulares").'
											, pelos Módulos relacionados nas Condições Particulares, pelas Condições Gerais e pelo Questionário
											apresentado pelo SEGURADO referente à cobertura oferecida por esta Apólice. <br>
			    ...
			    <div class="rounded" style="">
				    <table style="width:100%; border: 0;" >
						  <tr>
							...
							$sqlFranq = "SELECT Inf.nas, MO.franquia_anual, MO.d201, MO.nivel_d602, MO.b904 
				  ...
				  <div class="rounded" style="">
				    <table style="width:100%; border: 0;" >
						  ...
						  <tr>
								...
								<td style="text-align:center; width: 50%;"><b>João Rigobello</b></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							 	<td>&nbsp;</td>
								<td style="text-align:center; width: 50%;">Superintendente Técnico</td>
								<td style="text-align:center; width: 50%;">Diretor Comercial</td>
							</tr>							 
					  </table>
				  </div>';
			    ...
			    <table style="width:100%; border: 0;" >
					  <tr>
							<td colspan="4" style="text-align:right; width: 100%;">
								Ouvidoria Coface Seguros de Crédito S/A: 0800-770-7788.
							</td>
						</tr>
						<tr>
							<td colspan="4" style="text-align:right; width: 100%;">
						...
						<tr>
							<td colspan="4" style="text-align:right; width: 100%;">
								Central de Atendimento ao Segurado: (11) 5509 8181
							</td>
					  </tr>
						<tr>
							<td colspan="4" style="text-align:right; width: 100%;">
