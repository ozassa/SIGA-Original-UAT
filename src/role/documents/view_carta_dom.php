      ...
      $html .= ' <!--mpdf
					...
					if($idant == 1){
						$html .= '<div id="cobtexto">
							...
							Sendo um cliente da Coface do Brasil, subsidiária da Compagnie Française d&rsquo;Assurance pour le Commerce Extérieur, 
							...
							A Coface do Brasil agradece a sua confiança e reafirma o compromisso de continuar a oferecer as 
					...
					$html .= '<table style="width:100%; border: 0; font-size: 9px;" >
					  <tr>
