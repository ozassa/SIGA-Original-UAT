<?php 
	...
	$ssinatura  = $root .'images/Assinatura_Rigobello.jpg';
		           ...
		           $html .= '<b>CLÁUSULA 1ª - OBJETO -</b>
							...
							<br> 
							  <div id="cobtexto">
								...
								<br><br>
								2.4. Em caso de litígio entre o <b>SEGURADO</b> e o <b>IMPORTADOR</b> em relação aos valores de
								principal ou juros (operacionais e/ou de mora), o pagamento da <b>INDENIZAÇÃO</b> será
								suspenso até que ocorra a solução do mencionado <b>LITÍGIO</b>, nos termos previstos nas
								<b>CONDIÇÕES GERAIS da APÓLICE;</b>
							</div>
							 <br> 
							...
							<div style="text-align:center;">
							     <img src="'.$ssinatura.'" style="width: 140px; height: 80px;">						
							</div>
