...
if ($excel=="yes") {
  ...
  header('Content-Disposition: attachment; filename="apolices_cedidas_BB.xls"');
}
...
/*
 function GerarExcel(){
   ...
   'scrollbars=no,status=no,width=50,height=50,left=20,top=10,resizable=no');
 }
*/ 
...
<?php  echo "<br>Data:".date("d-m-Y H:i:s")."<br>";
...
<form name="frm_view_rel_apolice" action="view_apolices_cedidas_BB.php" method="post" target="_self">
