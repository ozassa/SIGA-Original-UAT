...
if ($excel=="yes") {
  ...
  header('Content-Disposition: attachment; filename="view_apolices_cedidas_OB.xls"');
}

//define a classe para abertura do banco de dados
require_once("../../dbOpen.php");

echo "Relatório de Apólices cedidas para outros Bancos<br>";
...
echo "Total de Apólices Cedidas para o outros Bancos:".$total;
