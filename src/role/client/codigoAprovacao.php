						 ...
						 <table width="100%">
						  ...
						  <tr>
						    <td colspan = "4" style="text-align: center;">							 
								<span style="font-weight: bold; font-size: 14pt;">CÓDIGO DE APROVAÇÃO</span>							 
						    </td>
						  </tr>
						...
						-->
							...
							<table width="100%" style="border:solid 1px #000;" cellspacing="0" cellpadding="3">					
							  <tr bgcolor="#CCCCCC">
								 ...
								 <td width="10%" style="border:solid 1px #000;"><strong>Código</strong></td>
								 <td width="85%" style="border:solid 1px #000;"><strong>Descrição</strong></td>
